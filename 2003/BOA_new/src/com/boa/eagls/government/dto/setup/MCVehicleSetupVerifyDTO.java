...
/**
 * <p><small> DVI Company, 28.07.2003 15:28:59</small></p>
 * @author GlebL
 */
public class MCVehicleSetupVerifyDTO {
    static final Logger logger =
            Logger.getLogger(MCVehicleSetupVerifyDTO.class);
    ...
    private String equipFuelLow;
    private String equipFuelHigh;
    ...
    private String generatePaperTransmit;
    private String hdn_agencyName;
    private String generatePaper;
    ...
    public String getGeneratePaper() {
        return generatePaper;
    }

    public void setGeneratePaper(String generatePaper) {
        this.generatePaper = generatePaper;
    }
    ...
    public void setHdn_centralName(String hdn_centralName) {
        this.hdn_centralName = hdn_centralName;
    }
    ...
    public String getEquipFuelLow() {
        return equipFuelLow;
    }

    public void setEquipFuelLow(String equipFuelLow) {
        this.equipFuelLow = equipFuelLow;
    }

    public String getEquipFuelHigh() {
        return equipFuelHigh;
    }

    public void setEquipFuelHigh(String equipFuelHigh) {
        this.equipFuelHigh = equipFuelHigh;
    }
    ...
    public String getGeneratePaperTransmit() {
        return generatePaperTransmit;
    }

    public void setGeneratePaperTransmit(String generatePaperTransmit) {
        this.generatePaperTransmit = generatePaperTransmit;
    }
