    	 ...
    	 if (theForm.chk_equipmentID.checked == true)
    	 	{    checkedOption=1;
				...
				theForm.txt_equipmentID.value = stringTrim(theForm.txt_equipmentID.value);
    	 		if ((parent.logo.checkEquipID(theForm,theForm.txt_equipmentID) == "error") ||
...
<html:form action="<%=Actions.SearchIndividualStatenment%>" name="theForm" type="com.boa.eagls.government.controller.formbean.transactiondata.IndividualStatementForm" onsubmit="return Form_Test(document.theForm);" >

<!--FORM NAME="theForm"
      ACTION="/cgi-bin/gx.cgi/GUIDGX-{AEF179A0-3CF3-11D2-9C2A-204C4F4F5020}"
      METHOD="Post"
...
<template:insert template="/jsp/gsa/common/header_systemDefault.jsp" >
    <template:put name="screenTitle-1" content="Individual Statement" direct="true"/>
    <template:put name="screenTitle-2" content="Setup" direct="true"/>
</template:insert>

<INPUT TYPE="HIDDEN" NAME="txt_screenTitle1" value="Individual Statement">
<!-------------------------------------------------------------------------->

<html:hidden value="Individual Statement Search" property="txt_screenTitle1"/>
    ...
    <TR>
      <TD WIDTH="575" ALIGN="Center"/>
        ...
        <html:reset value="Clear"
               onclick="resetHierarchy(document.theForm);"/>
      </TD>
    </TR>
</TABLE>


<B><FONT COLOR="#0000FF" FACE="Arial, Helvetica">Search For</FONT></B>
<TABLE>
    <TR>
      <TD WIDTH="20">
        <html:radio property="rag_statementSearch" value="<%=IndividualStmFormValues.CURRENT_TRANSACTIONS%>"
                onclick="parent.logo.Display_Message('Select Current Transactions');
                        theForm.txt_statementDate.value=''"/>
      </TD>
      <TD WIDTH="200">Current Transactions</TD>
    </TR>
    <TR>
      <TD>
        <html:radio property="rag_statementSearch" value="<%=IndividualStmFormValues.CURRENT_STATEMENT%>"
               onclick="parent.logo.Display_Message('Select Current Statement');
                        theForm.txt_statementDate.value=''"/>
      </TD>
    ...
    <TR>
      <TD>
        <html:radio property="rag_statementSearch" value="<%=IndividualStmFormValues.STATEMENT%>"
               onclick="parent.logo.Display_Message('Select Statement');
                        parent.logo.setFocus(theForm,theForm.txt_statementDate,'Enter Statement Date');"/>
      </TD>
      <TD>Statement</TD>
      <TD>
        <html:text property="txt_statementDate" size="8" maxlength="7"
               onfocus="parent.logo.Display_Message('Enter Statement Date');
			          theForm.rag_statementSearch[2].checked = true"/>&nbsp;(MM/YYYY)
      </TD>
    </TR>
    <TR>
      <TD></TD>
      <TD>Sort Transactions By</TD>
      <TD>
        <html:select property="sel_indTransSort" size="1">
          <html:option value="<%=IndividualStmFormValues.TRANSACTION_POST_DATE%>">Transaction Post Date</html:option>
          <html:option value="<%=IndividualStmFormValues.TRANSACTION_AMOUNT%>">Transaction Amount</html:option>
          <html:option value="<%=IndividualStmFormValues.TRANSACTION_STATUS%>">Transaction Status</html:option>
          <html:option value="<%=IndividualStmFormValues.MERCHANT_NAME%>">Merchant Name</html:option>
        </html:select>
      </TD>
    </TR>
    <TR/>
    <TR/>
    <!--GX type=cell id=nonAH-->
    <!--_______________________ Non-Account Holders only ____________________-->
    <TR>
      <TD ALIGN="Left" COLSPAN="3">
        <B><FONT COLOR="#0000FF" FACE="Arial, HELVETICA">Search By</FONT></B>
          ...
          <TD>
        <html:checkbox property="chk_accountNumber"
               onclick="accountNumberSet(document.theForm)"/>
      </TD>
      <TD>Account Number</TD>
      <TD>
        <html:text property="txt_accountNumber" size="20" maxlength="16"
    ...
    <TR>
      <TD  WIDTH=20>
        <html:checkbox property="chk_hierLevel" value="hierarchy"
...
<!-- end GSU ____________________________________________________________>
</GX>

<!----------------------------- Hidden Variables -------------------->

<GX type=replace id=navigate.searchForCriteriaTransmit value=placeholder>
  <INPUT TYPE="Hidden" NAME="hdn_searchForCriteria" VALUE="placeholder">
</GX>

<GX type=replace id=navigate.sortForTransmit value=placholder>
  <INPUT TYPE="Hidden" NAME="hdn_sortFor" VALUE="placholder">
</GX>
...
<TABLE>
    <TR>
      <TD WIDTH="575" ALIGN="Center"/>
        <html:submit value="Submit" onfocus="parent.logo.Display_Message('Submit')"></html:submit>
        &nbsp;&nbsp;

        <html:reset value="Clear"
               onclick="parent.logo.Display_Message('Clear');"/>
      </TD>
    </TR>
</TABLE>
