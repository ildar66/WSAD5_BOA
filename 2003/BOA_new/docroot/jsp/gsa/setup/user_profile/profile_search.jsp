...
<META NAME="Created"     CONTENT="06-03-03">
...
<body onLoad="resetIsLoaded();refreshHierarchy();callClearReviseHierarchy();populateReviseSearchHierarchy(document.forms[0]);">
<html:form  name="ProfileSearchForm" type="com.nb.gsa.controller.formbean.common.ProfileSearchActionForm" action="/profileSearch" onsubmit = "return Form_Test(document.forms[0]);">
<TABLE WIDTH="575">
    <TR>
      <TD ALIGN="Center">
...
<INPUT TYPE="HIDDEN" NAME="txt_screenTitle1" value="Create User Profile">
<IMG SRC="<%=request.getContextPath()%>/jsp/gsa/images/line.gif" WIDTH="575" HEIGHT="6">


<%@ include file="/jsp/gsa/common/dynamic_search.jsp"%>
